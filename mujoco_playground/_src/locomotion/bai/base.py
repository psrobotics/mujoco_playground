...
def get_assets() -> Dict[str, bytes]:
  ...
  mjx_env.update_assets(assets, consts.ROOT_PATH / "xmls")
  # we dont use menagerie
...
class BaiEnv(mjx_env.MjxEnv):
  ...
  def __init__(
    ...
    # mod, add imu site name here
    self._imu_site_id = self._mj_model.site("imu_torso").id
